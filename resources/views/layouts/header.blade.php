<header class="l-header p-header">
    <h1 class="p-header__logo">
        <a href="/"><img src={{ asset('image/sitelogo.svg') }}></a>
    </h1>
    <ul class="p-header-icons sp-only">
        @guest
            <li class="p-header-icon"><a href={{ route('login') }}><img src={{ asset('image/icon/user.svg') }}></a></li>
        @else
            <li class="p-header-icon"><a href="/users/{{ Auth::user()->id}}">
                @if(Auth::user()->profile_photo)
                <figure class="c-avator p-header-icon__avator">
                    <img src="{{ asset('storage/user_images/' . Auth::user()->profile_photo) }}.jpg" alt="">
                </figure>
            @else
                <figure class="c-avator p-header-icon__avator">
        ...
        <li class="p-header-icon js-search__open"><img src={{ asset('image/icon/search.svg') }}></li>
    </ul>
    <div class="p-header-humberger sp-only js-humberger">
        <span></span>
        <span></span>
        <span>Munu</span>
    </div>
    ...
    <div class="pc-only">
        ...
        <div class="p-header-humberger js-humberger">
            <span></span>
            <span></span>
            <span>Munu</span>
        </div>
                ...
                <ul class="p-header-menu__list">
                    ...
                    <li>
                        ...
                        <ul class="p-header-menu__list-sns">
                            ...
                            <li><a href="/"><svg class="as_facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36.71 36.71">
